...
public class GameResources {
    ...
    private static void EndLoadingScreen(int width, int height) {
        ...
        TryFreeSoundEffect(_StartSound);
    ...
    private static void TryFreeSoundEffect(SoundEffect obj)
    {
        try { Audio.FreeSoundEffect(obj); }
        catch (Exception e)
        {
            Console.Error.WriteLine("Ignoring attempt to free SoundEffect due to SwinGameSDK exception: " + e.Message);
        }
    }
}
